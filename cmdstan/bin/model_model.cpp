...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        pos__ = 0;
        T = vals_i__[pos__++];
        context__.validate_dims("data initialization", "V1", "double", context__.to_vec(T,1));
        validate_non_negative_index("V1", "T", T);
        validate_non_negative_index("V1", "1", 1);
        V1 = std::vector<std::vector<double> >(T,std::vector<double>(1,double(0)));
        vals_r__ = context__.vals_r("V1");
        pos__ = 0;
        size_t V1_limit_1__ = 1;
        ...
        context__.validate_dims("data initialization", "V2", "double", context__.to_vec(T,1));
        validate_non_negative_index("V2", "T", T);
        validate_non_negative_index("V2", "1", 1);
        V2 = std::vector<std::vector<double> >(T,std::vector<double>(1,double(0)));
        vals_r__ = context__.vals_r("V2");
        pos__ = 0;
        size_t V2_limit_1__ = 1;
        ...
        context__.validate_dims("data initialization", "V0", "double", context__.to_vec(2));
        validate_non_negative_index("V0", "2", 2);
        V0 = std::vector<double>(2,double(0));
        vals_r__ = context__.vals_r("V0");
        pos__ = 0;
        size_t V0_limit_0__ = 2;
        for (size_t i_0__ = 0; i_0__ < V0_limit_0__; ++i_0__) {
            V0[i_0__] = vals_r__[pos__++];
        }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        context__.validate_dims("initialization", "theta", "double", context__.to_vec(6));
        // generate_declaration theta
        std::vector<double> theta(6,double(0));
        for (int i0__ = 0U; i0__ < 6; ++i0__)
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            {
                vector<vector<T__> > V_hat(T, (vector<T__>(1)));
                ...
                lp_accum__.add(normal_log<propto__>(theta, 0, 2));
                current_statement_begin__ = 36;
                lp_accum__.add(normal_log<propto__>(V0, 5, 2));

...
namespace printer_model_namespace {
...
class printer_model : public prob_grad {
private:
    double x;
public:
    printer_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "printer_model_namespace::printer_model";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        if (stan::math::is_uninitialized(z)) {
            std::stringstream msg__;
            msg__ << "Undefined transformed parameter: z";
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "printer_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
...
typedef printer_model_namespace::printer_model stan_model;
